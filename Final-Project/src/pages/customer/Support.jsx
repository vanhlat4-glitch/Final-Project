...
export default function Support() {
  ...
  const myTickets = useMemo(() => items.filter((t) => String(t.fromId) === String(user.id) && t.fromRole === "customer"), [items, user.id]);

  async function handleSubmit(e) {
    e.preventDefault();
    setSaving(true);
    try {
      await create({ ...form, fromRole: "customer", fromId: user.id, status: "open", reply: "" });
  ...
  return (
    <DashboardLayout title="Hỗ trợ" subtitle="Gửi yêu cầu hỗ trợ kỹ thuật hoặc thắc mắc đến Morent">
